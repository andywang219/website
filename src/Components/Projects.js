    ...
    render() {
        return (
            <div className = "flexCenter">
                <h1 className = "subHeadings">Projects</h1>
                <Grid container spacing = {8} className = "flexRow" style = {{marginTop: '15px', width: "100%"}}>
                    <Grid item xs = "auto" sm = "auto" md = "auto" lg = "auto" xl = "auto">
                        <Paper className = "projects">
                            ...
                            <Typography className = "flexRow " variant = "display1" style = {{color: "black"}}>Krusty Krab Pizza</Typography>
                            <div className = "overlay flexCenter">
                                <div className = "text">
                                    ...
                                    <div className = "flexRow">
                                        <Button variant = "contained" size = "large" color = "primary" style = {{padding:'5px 5px', margin:'5px 5px', fontSize: "10px"}} href = "https://github.com/buenoluis007/Krusty_Krab_Pizza" target="_blank">GitHub</Button>
                                    </div>
                                </div>
                            </div>
                        </Paper>
                ...
                <Paper className = "projects">
                    ...
                    <Typography className = "flexRow" variant = "display1" style = {{color: "black"}}>CUNYfirst-RateMyProfessor Hybrid</Typography>
                    <div className = "overlay flexCenter">
                        <div className = "text">
                            ...
                            <div className = "flexRow">
                                <Button variant = "contained" size = "large" color = "primary" style = {{padding:'5px 5px', margin:'5px 5px', fontSize: "10px"}} href = "https://github.com/buenoluis007/CUNYFirst-RateMyProfessors-Hybrid" target="_blank">GitHub</Button>
                            </div>
                        </div>
                    </div>
                </Paper>
                ...
                <Paper className = "projects">
                    ...
                    <Typography className = "flexRow " variant = "display1" style = {{color: "black"}}>Personal Website</Typography>
                    <div className = "overlay flexCenter">
                        <div className = "text">
                            ...
                            <div className = "flexRow">
                                <Button variant = "contained" size = "large" color = "primary" style = {{padding:'5px 5px', margin:'5px 5px', marginTop:'5px', fontSize: "10px"}} href = "https://github.com/andywang219/website"  target="_blank">GitHub</Button>
                                <Button variant = "contained" size = "large" color = "secondary" style = {{padding: '5px 5px', margin: '5px 5px', marginTop: '5px', fontSize: "10px"}} href = "https://meetandy.net"  target = "_blank">Check it out!</Button>
                            </div>
                        </div>
                    </div>
                </Paper>
